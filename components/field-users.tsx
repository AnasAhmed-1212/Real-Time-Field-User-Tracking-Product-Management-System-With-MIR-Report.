...
export function FieldUsers() {
  const { data, setData, loading, error, refresh } = useAdminResource<FieldUser[]>("field-users", [])
  ...
  return <main className="flex-1 bg-muted/20 p-4 sm:p-6"><div className="mx-auto max-w-7xl space-y-5">
    ...
    {actionError && <ApiError title="Unable to update field user" message={actionError} />}
